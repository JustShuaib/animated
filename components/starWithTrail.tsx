...
const StarWithTrail = () => {
  useGSAP(() => {
    gsap.set(".trail-star", {y: -600, autoAlpha: 0});
    const tl = gsap.timeline({repeat: -1, yoyo: true});
    gsap.to(".trail-star", {y: 0, autoAlpha: 1, duration: 6, delay: 2});
    tl.to(".trail-star", {
      duration: 6,
      scale: 0.5,
  ...
  return (
    <svg
      ...
      className="trail-star w-14 h-14 absolute top-1/2 left-36"
    >
      <path
